...
import { initRunningScreen, showRunningScreen, setupRunningCallbacks } from './running-screen.js';
...
async function startApp() {
  ...
  // Bloc Running — injecter les callbacks app.js avant l'init
  setupRunningCallbacks({
    onSummary:     showRunSummaryWithJournal,
    loadCarnet:    _loadCarnet,
    getSaveJournal: () => _saveJournalToSession
  });
  initRunningScreen();

  // Écouter l'événement de navigation émis par running-screen.js
  window.addEventListener('trekko:switchPanel', e => switchToPanel(e.detail));
...
/* =========================================================
   ...
   Le code running a été extrait vers js/running-screen.js.
   initRunningScreen / showRunningScreen sont importés depuis ce module.
   ========================================================= */
// [bloc running extrait — voir js/running-screen.js]

// [running-screen extrait — voir js/running-screen.js]
